...
CREATE TABLE IF NOT EXISTS Endereco ( codEndereco INT NOT NULL AUTO_INCREMENT PRIMARY KEY, logradouro VARCHAR(200) NULL, numero INT, CEP INT, Cidade VARCHAR(100), UF CHAR(2) );
