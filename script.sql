...
CREATE TABLE IF NOT EXISTS Endereco ( codEndereco INT NOT NULL AUTO_INCREMENT PRIMARY KEY, bairro VARCHAR(200) NOT NULL, logradouro VARCHAR(200) NOT NULL, numero INT, CEP INT, Cidade VARCHAR(100), UF CHAR(2) );


CREATE TABLE IF NOT EXISTS Telefone (codTelefone INT NOT NULL AUTO_INCREMENT PRIMARY KEY, numTelefone INT );
